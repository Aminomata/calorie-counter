...
const CaloriesSlider = () => {
  ...
  return <div className="calories-container">
    <Stack direction="row" spacing={2}>
      <TextField type='number' className="calories-textfield" label="Calories" variant="outlined" value={calories} onChange={(event) => handleSetCalories(Number(event.target.value))} inputProps={{ inputMode: 'numeric', pattern: '[0-9]*' }} />
